...
\Typ{Master Colloquium}
\GradBetreuer{M.Sc.}
\Betreuer{Name der Betreuer}
% Wenn nicht vorhanden, leer lassen!
\GradEXBetreuer{Prof. Dr.}
\ExBetreuer{Name der ExBetreuer}
...
\logo{\includegraphics[width=\paperwidth]{Bilder/background.jpg}} % optionally

% alternative logo position (not recommended)
%\instlogo{\includegraphics[height=10mm]{logos/rwth_mentoring_rgb.eps}} % optionally
\instlogo{\includegraphics[height=7mm]{Bilder/logo.png}} % optionally
...
%%                 fulltoc:   display section table of all sections
